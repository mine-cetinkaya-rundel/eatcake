...
write_csv(pac_2020_fn, here::here("08-cerse/code/opensecrets/data/", "pac-2020-fn.csv"))
write_csv(pac_2018, here::here("08-cerse/code/opensecrets/data/", "pac-2018.csv"))
write_csv(pac_1998, here::here("08-cerse/code/opensecrets/data/", "pac-1998.csv"))
